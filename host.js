...
// Called from game.js whenever the score changes, to mirror it to the phone.
function sendScoreToController(currentScore) {
    if (conn && conn.open) {
        conn.send({ type: 'score', score: currentScore });
    }
}
